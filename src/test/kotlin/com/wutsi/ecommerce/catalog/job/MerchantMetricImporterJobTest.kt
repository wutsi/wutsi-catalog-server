...
internal class MerchantMetricImporterJobTest {
    @MockBean
    private lateinit var productMetricImporter: MerchantMetricImporter

    @MockBean
    private lateinit var scoreImporter: MerchantScoreImporter

    @MockBean
    private lateinit var clock: Clock

    @Autowired
    private lateinit var job: MerchantMetricImporterJob
