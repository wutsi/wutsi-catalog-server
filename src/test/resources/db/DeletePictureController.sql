INSERT INTO T_PRODUCT(id, tenant_id, account_id, title, summary, description, price, comparable_price, currency, visible, is_deleted)
    VALUES
        ...
        (200, 1, 1, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, false),
        (300, 1, 1, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, false),
        (900, 1, 2, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, true)
;
