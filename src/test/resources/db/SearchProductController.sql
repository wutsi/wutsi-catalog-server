...
INSERT INTO T_PRODUCT(id, tenant_id, account_id, category_fk, sub_category_fk, title, summary, description, price, comparable_price, currency, visible, is_deleted, total_views, score)
    VALUES
        (100, 1, 1, 100, 101, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, false, 5, 0.001),
        (101, 1, 1, 100, 102, 'Yo', 'Man', 'This is the description', 1100, 1500, 'XAF', true, false, 100, 0.1),
        (102, 1, 2, 100, 102, 'Yo', 'Man', 'This is the description', 1200, 1500, 'XAF', true, false, 90, 0.01),
        (109, 1, 1, 100, 102, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, true, 0, 0.0),

        (200, 1, 2, 200, 201, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, false, 90, 0.5),
        ...
        (2100, 2, 10, 200, 202, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, true, 0, 0.0),
        (2200, 2, 10, 200, 201, 'Yo', 'Man', 'This is the description', 1000, 1500, 'XAF', true, true, 0, 0.0)
;
